...
import { GetMotds, Motd } from "@/data-provider/contentful/provider/motd-provider";
import clsx from "clsx"

function Message({motd}: {motd: Motd}) {
    const colorClasses = clsx("flex flex-col w-full shadow-lg rounded-lg p-4",
...
export default async function Motds() {
    ...
    return (<div className="flex flex-col pt-4 gap-4">{messages.map((m) => (
